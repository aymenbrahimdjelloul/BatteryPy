...
class BatteryCLI:
    ...
    def _parse_arguments() -> argparse.Namespace:
        ...
        parser = argparse.ArgumentParser(
            description=f"{APP_CAPTION} - Battery Information Monitoring Tool",
    ...
    def _set_terminal_title() -> None:
        ...
        try:
            os.system(f"title {APP_CAPTION}" if batterypy.CURRENT_PLATFORM == "Windows" else
                      f'echo -ne "\033]0;{APP_CAPTION}\007"')
        except OSError:
            return None
    ...
    def _display_header(self) -> None:
        ...
        print(f""
              ...
              f"{self._center_text(f'{APP_CAPTION} - Developed by {AUTHOR}')}\n"
              f"{self._center_text(f'visit : {APP_WEBSITE}')}\n")
    ...
    def _display_version() -> None:
        ...
        print(f"\n{Colors.BOLD}Application  :{Colors.END}    {Colors.CYAN}{APP_CAPTION} v{VERSION}{Colors.END}")
